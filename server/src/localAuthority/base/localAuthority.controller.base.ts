...
export class LocalAuthorityControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: LocalAuthority })
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [LocalAuthority] })
  @swagger.ApiForbiddenResponse()
  @ApiNestedQuery(LocalAuthorityFindManyArgs)
  async findMany(@common.Req() request: Request): Promise<LocalAuthority[]> {
    const args = plainToClass(LocalAuthorityFindManyArgs, request.query);
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async findOne(
    @common.Param() params: LocalAuthorityWhereUniqueInput
  ...
  async update(
    @common.Param() params: LocalAuthorityWhereUniqueInput,
    @common.Body() data: LocalAuthorityUpdateInput
  ): Promise<LocalAuthority | null> {
    try {
